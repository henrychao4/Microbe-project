...
sigma_1 = .05
C = exp(-dists_1^2 / sigma_1)

cor_matrix = cor(C)
corrplot(cor_matrix, type = "upper",  
         method = "square",  
         addCoef.col = "black",  
         tl.col = "black", tl.srt = 45, title = "1 axis")
...
sigma_2 = .05
C_2ax = exp(- ((dists_1^2 / sigma_1) + (dists_2^2 / sigma_2)))
...
sigma_3 = .05
C_3ax = exp(- ((dists_1^2 / sigma_1) + (dists_2^2 / sigma_2) + (dists_3^2 / sigma_3)))
