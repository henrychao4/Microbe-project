...
plot(num_alpha, analytical_alpha)
abline(a = 0, b = 1)

plot(num_alpha[coex, coex], analytical_alpha[coex, coex])
abline(a = 0, b = 1)

analytical_intra_normal = analytical_alpha / diag(analytical_alpha)
num_intra_normal = num_alpha / diag(num_alpha)

plot(num_intra_normal[coex, coex], analytical_intra_normal[coex, coex])
abline(a = 0, b = 1)
